...
<html
  ...
  data-assets-path="@if(Auth::guard('admin')->check()) {{ asset('assets-back') }}
                    @elseif(Auth::guard('web')->check()) {{ asset('assets-front') }}
                    @elseif(Auth::guard('head')->check()) {{ asset('assets-head') }}
                    @elseif(Auth::guard('doctor')->check()) {{ asset('assets-doctor') }}
                    @endif/"
