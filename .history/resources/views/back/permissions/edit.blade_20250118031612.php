    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('back.permissions.update', $permission->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name',displayPermissionName($permission->name)) }}" placeholder="{{ old('name', $permission->name) }}" required>
            </div>
