...
Route::controller(HeadOfDepartmentController::class)->group(function () {
    ...
    Route::get('/head_of_departments/create', 'create')->name('head_of_departments.create');
    Route::post('/head_of_departments', 'store')->name('head_of_departments.store');
    Route::get('/head_of_departments/{head_of_department}/edit', 'edit')->name('head_of_departments.edit');
    Route::put('/head_of_departments/{head_of_department}', 'update')->name('head_of_departments.update');
    Route::delete('/head_of_departments/{head_of_department}', 'destroy')->name('head_of_departments.destroy');
});
