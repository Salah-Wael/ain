...
Route::get('excuses/create', [ExcuseController::class, 'create'])->name('excuses.create');
...
Route::get('excuses/{excuse}/edit', [ExcuseController::class, 'edit'])->name('excuses.edit');
Route::put('excuses/{excuse}', [ExcuseController::class, 'update'])->name('excuses.update');
Route::delete('excuses/{excuse}', [ExcuseController::class, 'destroy'])->name('excuses.destroy');
