...
Route::controller(DoctorController::class)->group(function () {
    ...
    Route::get('doctors/create', 'create')->name('doctors.create'); // Show form to create a doctor
    Route::post('doctors', 'store')->name('doctors.store'); // Store new doctor
    Route::get('doctors/{id}/edit', 'edit')->name('doctors.edit'); // Show form to edit a doctor
    Route::put('doctors/{id}', 'update')->name('doctors.update'); // Update a doctor's details
    Route::delete('doctors/{id}', 'destroy')->name('doctors.destroy'); // Delete a doctor
});
