...
class ExcuseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Save the excuse to the database and associate it with the authenticated student and department
        $student = Auth::user(); // Get the authenticated user (student)
        $student->excuses()->save($excuse); // The student can have many excuses, and we save the excuse

        // Associate the department with the excuse using the relationship
        $excuse->department()->associate($department); // Associate the department with this excuse
