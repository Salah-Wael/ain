...
class ExcuseController extends Controller
{
    ...
    public function update(Request $request, Excuse $excuse)
    {
        ...
        return redirect()->route('excuses.st')->with('success', 'Excuse updated successfully.');
    }

    public function updateStatus(Request $request, Excuse $excuse)
    {
        $request->validate([
            'status' => 'required|in:approved,rejected',
        ]);

        $excuse->update($request->only(['status']));
