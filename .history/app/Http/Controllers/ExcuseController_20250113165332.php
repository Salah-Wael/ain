...
class ExcuseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $department = \App\Models\Department::where('name', $request->input('department'))->first();
        ...
        $excuse = Excuse::create([
            ...
            'head_of_department_id' => $department->head_of_department_id, // Assume the department has a HoD
        ]);
