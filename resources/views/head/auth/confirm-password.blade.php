...
@section('content')
    ...
    <form id="formAuthentication" class="mb-3" action="{{ route('head.password.confirm') }}" method="POST">
        @csrf
    ...
    <div class="text-center">
        <a href="{{ route('head.login') }}" class="d-flex align-items-center justify-content-center">
